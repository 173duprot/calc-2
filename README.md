...
* [***Professor Leonard's complete collection of calc 2 class recordings***](https://www.youtube.com/playlist?list=PLDesaqWTN6EQ2J4vgsN1HyBeRADEh4Cw-)
    * ``This is a complete calc 2 class recorded and uploaded by a professor. While less concise than OCT, these classes delve deeper into each subject. If your having trouble with some very specific math section, these videos are a`definant go too.
